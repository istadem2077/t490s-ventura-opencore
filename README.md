# Lenovo ThinkPad T490s Hackintosh OpenCore
[![OpenCore](https://img.shields.io/badge/OpenCore-1.0.5-cyan.svg)](https://github.com/acidanthera/OpenCorePkg/releases/latest) [![macOS Sequoia](https://img.shields.io/badge/macOS-15.5-white.svg)](https://www.apple.com/macos/macos-sequoia/) [![release](https://img.shields.io/badge/Download-latest-success.svg)](https://github.com/5T33Z0/Thinkpad-T490-Hackintosh-OpenCore/releases/latest)<br>![10053604](https://github.com/5T33Z0/Thinkpad-T490-Hackintosh-OpenCore/assets/76865553/ed932a1a-8205-4b81-a4e2-f68d7d8a7178)
...
## About
OpenCore EFI folder and config for running macOS Sonoma and newer on the Lenovo ThinkPad T490s. Read the following documentation carefully in order to install/boot macOS successfully!
...
(In my case, it is not NVMe, but rather M.2 SATA SSD from Sk Hynix)

### Notable Features
- [x] Compatible with macOS Ventura (works with older versions of macOS as well, but requires different WiFi-Kexts and config adjustments)
...
**Storage** | ~~Samsung PM981a NVMe~~ ([**unusable**](https://dortania.github.io/Anti-Hackintosh-Buyers-Guide/Storage.html)) <br> Sk Hynix NVMe SSD
...
### Config Adjustments
- Download the [**latest Release**](https://github.com/istadem2077/t490s-ventura-opencore/releases/latest) of my EFI folder and unzip it
- Open the `config.plist` with a plist editor (e.g. ProperTree or OCAT) and adjust the following settings based on the used version of macOS and personal preferences:
	- **Graphics**
      ...
      - For Ventura 13.7, installer must be booted withh different boot-args that the one in the current config.plist: `-igfxblt -igfxbls -igfxbrs -igfxonln=1`, otherwise 5-minute black screen(Backlight doesn't turn on) 
	...
	- **Wi-Fi**: Decide, which Wi-Fi kext you want to use (&rarr; see [**AirportItlwm vs. itlwm**](#airportitlwmkext-vs-itlwmkext)):
    	- By default, since this EFI was built for Ventura primarily, there is only 1 AirportItlwm installed, 2.2.0 for Ventura. If you wanna use itlwm+Heliport, adapt the EFI accordingly. 
	- **Kernel/Quirks** 
...
- **AirportItlwm**: (used in macOS Ventura/Sonoma)
	- **Pro**: Can be used during macOS Setup/Recovery which is not possible with `itlwm.kext` (If you are in WPA2/3 Enterprise environment, use connect to other netowrk, and choose necessary encryption to connect)
	...
	- ~**Con**: iMessage and FaceTime don't work when using AirportItlwm (&rarr; See [Issue 14](https://github.com/5T33Z0/Thinkpad-T490-Hackintosh-OpenCore/issues/14))~ iServices do work.
...
- **T490 OpenCore Repos** used for referencing and ACPI hotfixes:
  ...
  - [5T33Z0](https://github.com/5T33Z0/Thinkpad-T490-Hackintosh-OpenCore)
  - [Newtonjobs](https://github.com/Newtonjobs/T490s-Hackintosh)
